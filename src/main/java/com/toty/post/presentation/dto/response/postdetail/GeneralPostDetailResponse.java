...
public class GeneralPostDetailResponse extends PostDetailResponse {
    public GeneralPostDetailResponse(String nickname, String profileImageUrl, PostCategory postCategory,
                                     String title, String content, List<PostImage> postImages, int viewCount, int likeCount, LocalDateTime earliestTime) {
