package com.toty.post.presentation.post.view;
...
import com.toty.post.application.postService.PostTagService;
...
public class PostViewController {
    ...
    public String myLikePostList(@CurrentUser User user,
                                 @RequestParam(name = "page", defaultValue = "1") int page,
                                 Model model) {
        model.addAttribute("page", page);
        return "user/myPostLikeList";
    }
