package com.toty.notification.infrastructure.sms.application.service;

import com.toty.common.baseException.NotificationSendException;
import com.toty.common.exception.ErrorCode;
import com.toty.common.exception.ExpectedException;
import com.toty.notification.infrastructure.sms.infrastructure.SmsConfig;
...
public class SmsService {
    ...
    private User validatedSmsUser(Long id) {
        ...
        if (!user.getUserSubscribeInfo().isSmsSubscribed()) {
